...
export const cursoData: Data[] = [
  ...
  },
  {
    ...
    inscricao: "De 03 de fevereiro a 03 de março de 2025",
    sobre:
      "O curso foi criado para profissionais de diversas áreas que desejam desenvolver competências técnicas e comportamentais essenciais para liderar equipes de forma eficaz. Ele é especialmente indicado para aqueles que ainda não assumiram formalmente cargos de liderança, mas que têm o objetivo de crescer profissionalmente e assumir novos desafios.\n Com uma abordagem prática, este curso prepara os participantes para os desafios reais da liderança no ambiente organizacional moderno, oferecendo ferramentas e estratégias para gerenciar equipes com confiança, promover o engajamento e alcançar resultados sólidos.",
    oQueLeva:
      "Assumir cargos de liderança com maior confiança e uma base técnica sólida.\n Utilizar ferramentas e estratégias para gerenciar equipes de maneira eficiente.\n Resolver conflitos e inspirar colaboradores por meio de habilidades comportamentais.\n Compreender os papéis e desafios do líder em diferentes contextos organizacionais.\n Desenvolver competências fundamentais como comunicação assertiva, gestão de conflitos, inteligência emocional e tomada de decisão.\n Promover o autoconhecimento para construir um estilo de liderança autêntico e eficaz.",
    paraQuem:
      "Profissionais que ainda não assumiram formalmente cargos de liderança, mas estão se preparando para isso.\n Pessoas com desejo de crescimento profissional e ascensão na carreira.\n Indivíduos de diferentes áreas que reconhecem a importância do desenvolvimento técnico e comportamental para assumir novos desafios.\n Profissionais que buscam uma abordagem prática e estratégica para liderar equipes e impulsionar resultados.",
    modulos: [
      {
