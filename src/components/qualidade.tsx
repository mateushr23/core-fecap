...
export function Qualidade() {
  return (
    <div className="h-[880px] w-screen text-center bg-white300 flex flex-col items-center justify-center">
      <h2 className="text-blue300 text-4xl">
        QUALIDADE <span className="font-bold">FECAP</span>
      </h2>
      <p className="lg:w-[990px] text-center mt-12 text-xl text-blue300">
